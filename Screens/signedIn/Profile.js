    ...
    <View style={styles.mainView}>
            ...
            <View style={styles.infoView}>
              ...
              <View style={styles.mainCol}>
                <View style={styles.column1}>
                  ...
                  <Text style={styles.txtCol1}>Tanggal Lahir</Text>
                  <Text style={styles.txtCol1}>E-mail</Text>
                  <Text style={styles.txtCol1}>Kelas</Text>
                  <Text style={styles.txtCol1}>No. Anggota</Text>
                </View>
                <View style={styles.column2}>
                  <Text style={styles.txtCol2}>: {item.namaLengkap}</Text>
                  <Text style={styles.txtCol2}>: {item.tglLahir}</Text>
                  <Text style={styles.txtCol2}>: {item.email}</Text>
                  <Text style={styles.txtCol2}>: {item.kelas}</Text>
                  <Text style={styles.txtCol2}>: {item.noAnggota}</Text>
                </View>
              </View>
            </View>
          </View>
      ...
      <View style={styles.buttonView}>
        <TouchableOpacity style={styles.Button} onPress={navigate}>
          <Text style={styles.btnText}>Kartu Digital</Text>
        </TouchableOpacity>
      </View>
